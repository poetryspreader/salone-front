...
<div class="updates-card">
    ...
    <ul class="updates-list">
        <li>Деньги на развоз теперь рассчитываются процентуально от каждого периода,</li>
        <li>итоговые чаевые по каждому сотруднику теперь округляются до ближайшего числа, кратного 5,</li>
        <li>добавлена общая сумма всех остатков от округлений.</li>
    </ul>
</div>
